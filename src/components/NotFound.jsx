  ...
  return (
    <div className="bg-red-100 min-h-screen flex flex-col items-center justify-center p-6">
      <div className="rounded-lg bg-red-50 border-red-200 border-2 p-6 max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-self  text-gray-800 mb-2">{title}</h1>
        ...
        <div className="flex justify-center gap-4 mt-6">
          <button
            onClick={() => navigate(-1)}
            className="px-4 py-2 bg-gray-200 shadow-xl  text-gray-700 rounded-lg hover:bg-gray-300 transition">
            Go Back
          </button>
          <Link
            to={"/"}
            className="px-4 py-2 shadow-xl bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Home
          </Link>
        </div>
      </div>
