  ...
  return (
    <>
      ...
      <div className="flex-1 p-4 flex flex-col justify-between">
        <div>
          <h2 className="text-md lg:text-lg  text-gray-800 mb-1">
            {item.title}
          </h2>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="bg-red-100 p-1 rounded-md border border-red-600 flex items-center text-red-600 hover:text-red-800 text-sm">
            <BiTrash size={18} className="mr-1" /> Remove
          </button>
          <span className="text-sm text-gray-600">Subtotal: $ {subtotal}</span>
        </div>
      </div>
    </>
  );
