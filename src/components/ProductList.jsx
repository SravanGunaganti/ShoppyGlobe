  ...
  return (
    <section className="w-full max-w-6xl mx-auto p-4">
      ...
      <div
        ...
        {showFilters && (
          <div className="grid grid-cols-2 h-full max-[350px]:text-xs text-sm md:text-base w-full gap-4">
            ...
            <div className="self-end col-span-1 flex justify-center items-center h-full border border-gray-400 rounded-md px-3 py-2">
              <select
                value={sortKey}
                onChange={(e) => setSortKey(e.target.value)}
                className="outline-0 w-full">
          ...
          <div
            ...
            {categories?.map((cat) => (
              <button
                ...
                }  py-2 px-3 rounded-md text-nowrap`}>
      ...
      <div className="flex justify-between items-center mb-4 max-[350px]:text-xs text-sm md:text-base">
        ...
        <button
          onClick={handleRetry}
          className="flex items-center gap-2 px-4 py-2 bg-white  border text-blue-600 border-blue-600 rounded-lg shadow-lg hover:bg-blue-50 transition">
          <BiRefresh />
          Reset Filters
        </button>
      </div>
      ...
      {totalPages > 1 && (
        <div className="mt-8 flex justify-center text-base items-center space-x-2">
          <button
            ...
            className="self-stretch px-3 py-2 bg-gray-100 border rounded-lg shadow-md hover:bg-gray-200 disabled:opacity-50">
            <BiChevronLeft />
          </button>

          <p
            className={`px-3 py-2 rounded-lg transition bg-blue-600 text-white`}>
          ...
          <button
            ...
            className="px-3 py-2 self-stretch  bg-gray-100 rounded-lg border  hover:bg-gray-200 shadow-md disabled:opacity-50">
            <BiChevronRight />
          </button>
        </div>
      )}
